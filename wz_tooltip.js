...
config. BgColor			= '#E0FFFF'	// Background colour (HTML colour value, in quotes)
...
config. Width			= 210			// Tooltip width; 0 for automatic adaption to tooltip content; < -1 (e.g. -240) for a maximum width for that automatic adaption;
